...
export const GALLERYITEMS: galleryItem[] = [
  {
    src: IMAGES.g52,
    title: "Bright and Airy White Closet - Luxe Kitchen Cabinets",
    desc: "Add a touch of brightness and freshness to your bedroom with this beautiful white closet. Featuring a spacious interior and a clean design, it's perfect for storing your favorite clothes and accessories while keeping your bedroom clutter-free",
  },
  {
    src: IMAGES.g51,
    title: "Classic Black and White Kitchen - Luxe Kitchen Cabinets",
    desc: "Create a timeless and sophisticated atmosphere in your kitchen with this stunning black and white design. Featuring cabinets, countertops, and a convenient dining area, it's perfect for modern homes and families.",
  },
  {
    src: IMAGES.g50,
    title: "Classic Black and White Kitchen - Luxe Kitchen Cabinets",
  ...
  {
    src: IMAGES.g48,
    title: "White Kitchen Oasis - Luxe Kitchen Cabinets",
    desc: "Create a warm and inviting atmosphere in your kitchen with this beautiful design. Complete with white cabinets, a shelf with drawer.",
  },
  {
    src: IMAGES.g47,
    title: "White Kitchen Oasis with Dining Area - Luxe Kitchen Cabinets",
    desc: "Create a warm and inviting atmosphere in your kitchen with this beautiful design. Complete with white cabinets, a shelf with drawer, and a spacious dining area, it's ideal for entertaining and everyday meals.",
  },
  {
    src: IMAGES.g46,
    title: "Timeless Elegance White and Black Kitchen Design - Luxe Kitchen Cabinets",
    desc: "Elevate your kitchen style with this classic and modern white and black theme. Featuring cabinets, a shelf with drawer, and a spacious dining area, it's perfect for creating a warm and inviting space for family and friends.",
  },
  {
    src: IMAGES.g45,
    title: "luxurious Double Sink Bathroom Vanity with Storage and Mirrors - Luxe Kitchen Cabinets",
    desc: "Maximize your bathroom space with this sleek and functional double sink vanity, complete with white cabinets, a drawer, and double mirrors for a spa-like ambiance.",
  },
  {
    src: IMAGES.g44,
    title: "Modern Contrast: Black Sink with White Drawer - Luxe Kitchen Cabinets",
    desc: "Add a touch of sleek sophistication to your bathroom or kitchen with this striking combination of a black sink and white drawer.",
  },
  {
    src: IMAGES.g43,
    title: "White Kitchen Oasis with Dining Area - Luxe Kitchen Cabinets",
  ...
  {
    src: IMAGES.g42,
    title: "Modern White Table with Drawer - Luxe Kitchen Cabinets",
    desc: "Elevate your home decor with this sleek and modern white table, complete with a drawer for keeping essentials within easy reach.",
  },
  {
    src: IMAGES.g41,
    title: "White Kitchen Oasis with Dining Area - Luxe Kitchen Cabinets",
  ...
  {
    src: IMAGES.g40,
    title: "Double Sink Bathroom Vanity with Storage and Mirrors - Luxe Kitchen Cabinets",
    desc: "Maximize your bathroom space with this sleek and functional double sink vanity. Complete with cabinets, a drawer, and double mirrors, it's ideal for busy families, shared bathrooms, or modern bathroom designs.",
  },
  {
    src: IMAGES.g39,
    title: "Convenient Storage: Attached Drawer - Luxe Kitchen Cabinets",
    desc: "Keep your essentials within easy reach with this handy attached drawer. Perfect for storing utensils, cleaning supplies, or personal items.",
  },
  {
    src: IMAGES.g38,
    title: "Double Sink Bathroom Vanity with Storage and Mirrors - Luxe Kitchen Cabinets",
  ...
  {
    src: IMAGES.g37,
    title: "All-White Cabinets for a Modern and Sleek Kitchen - Luxe Kitchen Cabinets",
    desc: "Elevate your kitchen style with these sleek and sophisticated all-white cabinets. Ideal for creating a bright, airy, and modern cooking space.",
  },
  {
    src: IMAGES.g36,
    title: "All-White Cabinets for a Modern and Sleek Kitchen - Luxe Kitchen Cabinets",
  ...
  {
    src: IMAGES.g35,
    title: "All-in-One Bathroom Solution: Sink, Cabinets, Drawer, and Mirror - Luxe Kitchen Cabinets",
    desc: "Optimize your bathroom layout with this compact and practical vanity combination. Featuring a sink, cabinets, drawer, and mirror, it's perfect for small bathrooms, apartments, or condos.",
  },
  {
    src: IMAGES.g1,
    title: "Luxurious Kitchen Haven - Luxe Kitchen Cabinets",
    desc: "Experience the epitome of luxury with LUXE kitchen cabinets. This stunning kitchen features our signature wooden cabinets, shelves, and drawers, perfectly complemented by a beautiful dining table. Let us help you create your dream kitchen!",
  },
  {
    src: IMAGES.g2,
    title: "Elevate Your Style with Custom Closet Storage - Luxe Kitchen Cabinets",
    desc: "Maximize your closet space with LUXE custom closet solutions. Our expertly crafted drawers and storage systems keep your clothing and accessories organized and within reach.",
  },
  {
    src: IMAGES.g3,
    title: "Timeless Elegance: White Kitchen Design - Luxe Kitchen Cabinets",
    desc: "Create a sense of warmth and welcome with LUXE white kitchen cabinets. This stunning kitchen features sleek drawers, shelves, and cabinets, perfect for a modern and elegant look.",
  },
  {
    src: IMAGES.g5,
    title: "Rustic Charm: Light Brown and Off-White Kitchen - Luxe Kitchen Cabinets",
    desc: "Experience the warmth and character of a rustic kitchen with LUXE. Our custom light brown and off-white cabinets, shelves, and drawers bring a sense of coziness and comfort to your cooking space.",
  },
  {
    src: IMAGES.g6,
    title: "Timeless Elegance: White Kitchen Design - Luxe Kitchen Cabinets",
  ...
  {
    src: IMAGES.g7,
    title: "Luxury Kitchen with Golden Accents - Luxe Kitchen Cabinets",
    desc: "Elevate your cooking space to new heights of luxury with LUXE custom kitchen cabinets, shelves, and drawers. The stunning golden handles add a touch of sophistication and glamour.",
  },
  {
    src: IMAGES.g8,
    title: "Light Brown Kitchen with Warm and Welcoming Ambiance - Luxe Custom Closets",
    desc: "Experience the warmth and coziness of a light brown kitchen with LUXE. Our custom cabinets, shelves, and drawers provide ample storage, while the small dining area adds a touch of charm and character.",
  },
  {
    src: IMAGES.g9,
    title: "Luxurious Black and White Kitchen with Golden Accents - Luxe Kitchen Cabinets",
    desc: "Experience the ultimate in kitchen sophistication with LUXE. This stunning black and white kitchen features large cabinets, shelves, and drawers, along with a beautiful base sink and golden handles that add a touch of luxury.",
  },
  {
    src: IMAGES.g10,
    title: "Modern Contrast: Black and White Kitchen Style - Luxe Kitchen Cabinets",
    desc: "Create a striking and modern look with LUXE black and white kitchen solutions. This stylish kitchen features custom cabinets, shelves, and drawers, along with a compact base sink.",
  },
  {
    src: IMAGES.g11,
    title: "Elegant Cabin: Black Door with Clear Glass - Luxe Kitchen Cabinets",
    desc: "Make a statement with LUXE elegant cabin . The sleek black door with clear glass adds a touch of luxury and sophistication.",
  },
  {
    src: IMAGES.g12,
    title: "LModern Kitchen Retreat - Luxe Kitchen Cabinets",
    desc: "Escape to a kitchen paradise with LUXE. Our expertly designed cabinets, shelves, and drawers provide ample storage, while the compact base sink adds a touch of modern elegance.",
  },
  {
    src: IMAGES.g13,
    title: "Small Place Solutions: Small Sink With Cabinets - Luxe Kitchen Cabinets",
    desc: "Optimize your small bathroom with LUXE. Our compact sink cabinet features a small sink and ample storage, making it the perfect solution for tiny spaces.",
  },
  {
    src: IMAGES.g14,
    title: "Luxurious Double Sink Vanity with Storage - Luxe Kitchen Cabinets",
    desc: "Elevate your bathroom experience with LUXE. This stunning double sink vanity features ample storage with drawers and cabinets, perfect for keeping essentials within reach.",
  },
  {
    src: IMAGES.g15,
    title: "Elegance: White and Grey Kitchen Storage - Luxe Kitchen Cabinets",
    desc: "Add a touch of sophistication to your kitchen with LUXE. This sleek white shelf paired with grey drawers and cabinets creates a harmonious and modern look.",
  },
  {
    src: IMAGES.g16,
    title: "Bright and Beautiful: All-White Kitchen Cabinets - Luxe Kitchen Cabinets",
    desc: "TCreate a sense of warmth and welcome in your kitchen with LUXE. Our all-white kitchen cabinets, shelf, and drawers offer ample storage and a bright, airy feel.",
  },
  {
    src: IMAGES.g17,
    title: "Bright and Beautiful Kitchen Oasis - Luxe Kitchen Cabinets",
    desc: "Create a sense of warmth and welcome in your kitchen with LUXE. Our all-white kitchen cabinets, shelf, drawers, and sink offer ample storage and a bright, airy feel.",
  },
  {
    src: IMAGES.g18,
    title: "Bright and Beautiful Kitchen Oasis - Luxe Kitchen Cabinets",
  ...
  {
    src: IMAGES.g20,
    title: "Tiny Treasure: Small White Two-Door Cabinet - Luxe Kitchen Cabinets",
    desc: "Discover the perfect solution for small space storage with LUXE this adorable white cabinet. Featuring two doors and a compact design, it's ideal for tucking away small items and keeping your space clutter-free.",
  },
  {
    src: IMAGES.g21,
    title: "White Kitchen Perfection - Luxe Kitchen Cabinets",
    desc: "Experience the ultimate in kitchen design with LUXE all-white cabinets, shelf, and drawer. A perfect blend of style, functionality, and sophistication.",
  },
  {
    src: IMAGES.g22,
    title: "Elevate Your Style with Custom Closet Storage - Luxe Kitchen Cabinets",
  ...
  {
    src: IMAGES.g23,
    title: "Modern Wooden Media Wall for a Sleek and Stylish Home - Luxe Kitchen Cabinets",
    desc: "Combine style and functionality with this sleek wooden media wall. Designed to hold your TV, soundbar, and other media devices, it's perfect for creating a modern entertainment hub in your home.",
  },
  {
    src: IMAGES.g24,
    title: "Light Brown Cabinets for a Bright and Airy Kitchen - Luxe Kitchen Cabinets",
    desc: "Bring a sense of brightness and warmth to your kitchen with these beautiful light brown cabinets. Ideal for creating a spacious and welcoming feel.",
  },
  {
    src: IMAGES.g44,
    title: "Light Brown Cabinets for a Bright and Airy Kitchen - Luxe Kitchen Cabinets",
